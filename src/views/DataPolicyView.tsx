      ...
      >
        <Paper elevation={0}>
          ...
          <span>
            ...
            <br />
            <br />
            If you have any questions or want to know more about how we use your
            personal information, please contact us as stated in section 6. We
            promise to keep your data safe and to not to sell your data to third
            parties. We promise to give you the right to access and delete your
            data.
          </span>
        </Paper>
      </Grid>
      ...
      >
        <Paper elevation={0}>
          ...
          <span>
            ...
            <br />
            <br />
            Data that you explicitly provide us with:
          </span>
          <br />
          <ul>
            <li>Username</li>
          ...
          <span>
            ...
            an account in our game.
          </span>
          <br />
          <br />
          <span>
            You have a right to withdraw your consent at any time as described
            under section 6 below.   
          </span>
          <br />
          <br />
          <span>
            We may receive data about you from third parties or partners. We use
            the following third-party services: 
          </span>
          <ul>
            <li>Unity Analytics (All platforms)</li>
            <li>GameSparks (All platforms)</li>
            <li>Firebase (All platforms)</li>
          </ul>
        </Paper>
      </Grid>
      <Grid
      ...
      >
        <Paper elevation={0}>
          ...
          <span>
            ...
            <br />
            <br />
            We will not use your data for any other purpose than the purpose for
            which the data is originally collected. To operate our business and
            to enhance your gaming experience, we use your information in the
            following ways:
          </span>
          <ul>
      ...
      >
        <Paper elevation={0} style={{ paddingBottom: '100px' }}>
          ...
          <span>
            ...
            removed and unrecoverable, effective immediately.
            <br />
            <br />
            To close your account, access your data or if you have any
            questions, please send us an email at{' '}
            <a href='mailto:maadwalk@gmail.com'>maadwalk@gmail.com</a>. If the
            contact concerns data collection, please include your account name
